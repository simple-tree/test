...
//   return (
//     <section className="flex flex-col items-center uppercase max-w-[16.125rem] mx-auto">
//       <div className="flex flex-col px-[0.125rem] w-full max-w-[16.125rem]">
//         <TextContent text={mainText} />
//         <img
//           loading="lazy"
//           src="https://cdn.builder.io/api/v1/image/assets/TEMP/0c556c60fa480feeffc88fd275f8197b7788725df87ae4b20245fb121f55859e?placeholderIfAbsent=true&apiKey=479d9a7dd9a245609744dbc312d000df"
...
//         />
//       </div>
//       <div className="flex gap-[0.15625rem] justify-center items-center mt-[1.25rem] w-full max-w-[16.125rem]">
//         <div className="flex flex-col gap-[0.15625rem] w-full">
//           {statements.map((statement, index) => (
//             <Statement key={index} text={statement} />
//           ))}
//         </div>
