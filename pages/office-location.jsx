  ...
  return (
    <div>
      ...
      <div className={styles.mapContainer}>
        ...
        dangerouslySetInnerHTML={{
          __html: `<iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.57028416252!2d90.39980557595854!3d23.798311786934136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c71001836335%3A0xaaebb736cbc14877!2sVOLUMEZERO%20Limited!5e0!3m2!1sen!2sbd!4v1720420089121!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`,
        }}
      /> */}
        ...
        <div
          className={styles.mapWrapper}
          dangerouslySetInnerHTML={{
            __html: `<iframe class="map" src="https://www.google.com/maps/d/embed?mid=1wiALfOZW2HXQmdMjgWI5z8jwggygVt0&ehbc=2E312F" width="640" height="480"></iframe>`,
          }}
        />
